...
class UpdateLocation extends StatefulWidget {
  Trip trip;
  UpdateLocation({super.key, required this.trip});
...
class _UpdateLocationState extends State<UpdateLocation> {
  ...
  void initState() {
    ...
    _controllerName.text = widget.trip.latitude.toString();
    super.initState();
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          widget.trip == null ? "Form Add" : "Change Data",
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      int idtrip = 0;
                      double latitude = double.parse(_controllerName.text);
                      Trip trip = Trip(id: idtrip, latitude: latitude,longitude:0.25052004);
                      trip.id = widget.trip.id;
                      tripService.updateLocations(trip).then((isSuccess) {
